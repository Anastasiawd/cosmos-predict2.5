...
vln_cosmos_subclip_index_dataset_29f_272_480 = L(VideoDataset)(
    dataset_dir="datasets/vln_cosmos_subclips_index",
    manifest_path="manifest.jsonl",
    num_frames=29,
    video_size=(272, 480),
    caption_format="manifest",
    sample_mode="center",
    negative_caption_strategy="directional",
    directional_negative_prob=0.7,
)

vln_cosmos_subclip_index_dataloader_train_29f_272_480 = L(get_generic_dataloader)(
    dataset=vln_cosmos_subclip_index_dataset_29f_272_480,
    sampler=L(get_sampler)(dataset=vln_cosmos_subclip_index_dataset_29f_272_480),
    batch_size=28,
    drop_last=True,
    num_workers=8,
    pin_memory=True,
...
predict2_video2world_training_2b_vln_subclips_align_29f_10fps_272_480 = dict(
    defaults=[
        f"/experiment/{DEFAULT_CHECKPOINT_2B.experiment}",
        {"override /model": "fsdp_vln_alignment"},
        {"override /data_train": "mock"},
        {"override /data_val": "mock"},
        "_self_",
    ],
    dataloader_train=vln_cosmos_subclip_index_dataloader_train_29f_272_480,
    checkpoint=dict(
        save_iter=2000,
    ...
    job=dict(
        project="cosmos_predict_v2p5",
        group="video2world",
        name="2b_vln_subclips_align_29f_10fps_272x480_h200x4",
        wandb_mode="disabled",
    ),
    optimizer=dict(
        lr=3e-5,
    ...
    trainer=dict(
        ...
        callbacks=dict(
            ...
            every_n_sample_reg=dict(every_n=0, save_s3=False),
            every_n_sample_ema=dict(every_n=0, save_s3=False),
    ...
    model=dict(
        config=dict(
            ...
            max_num_conditional_frames=2,
            conditional_frames_probs=None,
            language_alignment_weight=0.1,
            language_alignment_margin=0.05,
            language_alignment_t_min=0.2,
            language_alignment_t_max=0.8,
            pose_aux_weight=0.0,
            conditioner=dict(
...
for _item in [
    ...
    predict2_video2world_training_2b_vln_subclips_align_29f_10fps_272_480,
]:
